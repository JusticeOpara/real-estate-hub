  ...
  const handlePageChange = (newPage: number) => {
    ...
    <div className="min-h-screen bg-[#141414] py-8">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        {/* Header */}
        <div className="mb-8">
          <h1 className="text-4xl font-bold text-white mb-2">Browse Properties</h1>
        ...
        {loading ? (
          ...
          <div className="text-center py-20">
            <div className="bg-[#1A1A1A] border border-[#262626] rounded-xl p-12">
              <div className="text-6xl mb-4">🏠</div>
              <h3 className="text-2xl font-semibold text-white mb-2">No Properties Found</h3>
              <p className="text-[#999999]">Try adjusting your search filters</p>
            </div>
          </div>
        ) : (
          <>
            ...
            {pagination.pages > 1 && (
              <div className="mt-12 flex items-center justify-center space-x-2">
                <button
                  ...
                  className="p-2 rounded-lg border border-[#262626] text-[#999999] hover:bg-[#1A1A1A] hover:border-[#703BF7] disabled:opacity-50 disabled:cursor-not-allowed transition-all"
                >
                  ...
                  <button
                    ...
                    className={`px-4 py-2 rounded-lg font-medium transition-all ${
                      page === pagination.page
                        ...
                        : 'border border-[#262626] text-[#999999] hover:bg-[#1A1A1A] hover:border-[#703BF7]'
                    }`}
                  >
                    {page}
                  </button>
